...
public class API
{
    public static int GetCreatureKillCount(string creatureID) => !CritterHelper.namedCritters.TryGetValue(creatureID, out var critter) ? 0 : PlayerInfo.GetPlayerStat(PlayerInfo.RecordType.Kill, critter.character.m_name);
