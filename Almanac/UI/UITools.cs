...
public static class UITools
{
    ...
    public static Button AddButtonComponent(GameObject prefab, Image? iconImage, bool interactable, UnityAction action)
    {
        Button button = prefab.AddComponent<Button>();
    ...
    public static void SetupButton(GameObject prefab, Image iconImage, bool interactable, UnityAction action)
    {
